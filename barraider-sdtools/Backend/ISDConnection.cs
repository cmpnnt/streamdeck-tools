...
namespace BarRaider.SdTools.Backend
{
    ...
    public interface ISdConnection : IDisposable
    {
        ...
        /// <returns></returns>
        Task SendToPropertyInspectorAsync(JsonObject settings);
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        Task SetSettingsAsync(JsonObject settings);
        ...
        /// <returns></returns>
        Task SetGlobalSettingsAsync(JsonObject settings, bool triggerDidReceiveGlobalSettings = true);
        ...
        /// <summary>
        /// Sets the values of touchpad layouts items using a preset JsonObject
        /// </summary>
        /// <param name="feedbackPayload"></param>
        /// <returns></returns>
        Task SetFeedbackAsync(JsonObject feedbackPayload);
